...
$conn = OpenCon();
$current_animal = $_SESSION['remove_aid'];
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $update_sql = "UPDATE animal SET Available=0, Removed_by=$curr_pid WHERE AID='$curr_aid'";
                        ...
                        <div class="row gtr-50" style="text-align:center;">
                            ...
                            <div class="col-12">
                                <ul class="actions" style="text-align:center;">
                                    <?php
                                        if($current_animal['Available'] == 1)
                                            echo '<li><input type="Submit" value="Remove" /></li>';
                                    ?>
